...
`.agents/skills/` is the **cross-client interoperability** location: tools
...
skills directory. Project-level skills (this repo's `.agents/skills/`)
override user-level skills (`~/.agents/skills/`) on a name collision.
