#!/usr/bin/env node
/**
 * Scaffold a new skill under .agents/skills/<name>/ from
 ...
 *
 * Example:
 *   node .agents/skills/create-skill-pro/scripts/new-skill.mjs add-tauri-command \
...
function main() {
  ...
  if (fs.existsSync(skillDir)) {
    throw new Error(`.agents/skills/${name}/ already exists.`);
  }
  ...
  console.log(`Created .agents/skills/${name}/SKILL.md`);
